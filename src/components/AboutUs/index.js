...
import zally from "../../assets/zally.svg"
...
export const AboutUs = () => {
    ...
    <section classname="aboutus__container">
        ...
        <p className="aboutus__text">El proyecto ChartCovid es una demostración del equipo Platzi Master el cual tiene el objetivo de mostrar las actualizaciones por medio de Charts sobre el estatus actual de la pandemia COVID-19, se actualiza constantemente y tiene sus Charts de países de mayor a menor infectados así como su top de recuperados y su histórico del país de donde el usuario provenga.  </p>
